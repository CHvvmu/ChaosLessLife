...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: A4AnalyticsWidget.routeName,
          path: A4AnalyticsWidget.routePath,
          builder: (context, params) => A4AnalyticsWidget(),
        ),
        FFRoute(
          name: A5IntegrationsCRMWidget.routeName,
          path: A5IntegrationsCRMWidget.routePath,
          builder: (context, params) => A5IntegrationsCRMWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          builder: (context, params) => BiometricUnlockPageWidget(),
        ),
        FFRoute(
          name: TaskEditorPageWidget.routeName,
          path: TaskEditorPageWidget.routePath,
          asyncParams: {
            'taskItem': getDoc(['Tasks'], TasksRecord.fromSnapshot),
          },
          builder: (context, params) => TaskEditorPageWidget(
            taskItem: params.getParam(
              'taskItem',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: A3AIMessagingHubWidget.routeName,
          path: A3AIMessagingHubWidget.routePath,
          builder: (context, params) => A3AIMessagingHubWidget(),
        ),
        FFRoute(
          name: CallAssistantWidget.routeName,
          path: CallAssistantWidget.routePath,
        ...
        FFRoute(
          name: A3CallAnalyticsReportsWidget.routeName,
          path: A3CallAnalyticsReportsWidget.routePath,
          builder: (context, params) => A3CallAnalyticsReportsWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: VoiceCapturePageWidget.routeName,
          path: VoiceCapturePageWidget.routePath,
          builder: (context, params) => VoiceCapturePageWidget(),
        ),
        FFRoute(
          name: PlanBoardPageWidget.routeName,
          path: PlanBoardPageWidget.routePath,
          builder: (context, params) => PlanBoardPageWidget(),
        ),
        FFRoute(
          name: TaskReviewPageWidget.routeName,
          path: TaskReviewPageWidget.routePath,
          asyncParams: {
            'taskDraft': getDoc(
                ['AI_sessions', 'tasksSub'], TasksSubRecord.fromSnapshot),
          },
          builder: (context, params) => TaskReviewPageWidget(
            taskDraft: params.getParam(
              'taskDraft',
              ParamType.Document,
            ),
          ),
